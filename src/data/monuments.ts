...
export const MONUMENTS: Monument[] = [
  ...
  },
  {
    ...
    type: 'museo',
    image: 'https://www.mexicodesconocido.com.mx/wp-content/uploads/2020/11/46171515_319810011943872_8112943512745410560_n.jpg',
  },
  {
    id: 'memorial-68',
    name: 'Museo Memorial del 68',
    category: 'Museo Histórico',
    dist: '2.2 km',
    lat: 19.4509,
    lng: -99.1368,
    emoji: '🎗️',
    desc: 'Ubicado en Tlatelolco, es un espacio de memoria dedicado al movimiento estudiantil de 1968 y la lucha por los derechos humanos en México.',
    audioDuration: '3:40',
    type: 'museo',
    image: 'https://img.gruporeforma.com/imagenes/960x640/5/234/4233146.jpg',
  },
  {
    id: 'el-rule',
